...
/***/function (module, exports, __webpack_require__) {
	...
	var simpleheat = __webpack_require__(1);
	...
	L.HeatLayer = (L.Layer ? L.Layer : L.Class).extend({
		...
		_initCanvas: function _initCanvas() {
			...
			if (this.options.opacity) {
				this._heat.fixedOpacity(this.options.opacity);
			}
			this._updateOptions();
		},
...
/***/function (module, exports, __webpack_require__) {
	...
	simpleheat.prototype = {
		...
		fixedOpacity: function fixedOpacity(_fixedOpacity) {
			this._fixedOpacity = _fixedOpacity;
			return this;
		},
		...
		_colorize: function _colorize(pixels, gradient) {
			for (var i = 0, len = pixels.length, j; i < len; i += 4) {
				...
				if (j) {
					...
					if (this._fixedOpacity != null) pixels[i + 3] = this._fixedOpacity;
				}
			}
		},
